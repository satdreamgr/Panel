...
class PictureCamera(Screen):
	skin = """
	<screen name="PictureCamera" flags="wfNoBorder" position="0,0" size="1280,720" backgroundColor="transparent">
    <widget name="title" render="Label" position="40,30" size="1210,60" backgroundColor="#50000000" zPosition="5" font="Regular; 28" valign="center" halign="center" noWrap="1" foregroundColor="#00f47d19" />
	<widget name="menu" position="47,140" size="425,453" scrollbarMode="showOnDemand" halign="center" alphatest="on" backgroundColor="#20000000" font="Regular; 22"/>
	<eLabel name="" position="40,90" size="437,554" zPosition="-2" backgroundColor="#20000000" />
	...
	<widget name="pic" position="480,93" size="770,548" halign="center" alphatest="on" backgroundColor="#20000000"/>
	<eLabel name="" position="480,93" size="770,548" zPosition="-1" backgroundColor="#20000000" />
    ...
    <eLabel text="Exit" position="40,650" size="302,50" zPosition="5" font="Regular;22" halign="center" valign="center" transparent="1" foregroundColor="#00fefefe" backgroundColor="#20000000" />
    <eLabel text="Ok" position="342,650" size="302,50" zPosition="5" font="Regular;22" halign="center" valign="center" transparent="1" foregroundColor="#00fefefe" backgroundColor="#20000000" />
    <widget name="download" position="644,650" zPosition="5" size="302,50" font="Regular;22" halign="center" valign="center" transparent="1" foregroundColor="#00fefefe" backgroundColor="#20000000" />   
    <eLabel text="Info" position="946,650" size="302,50" zPosition="5" font="Regular;22" halign="center" valign="center" transparent="1" foregroundColor="#00fefefe" backgroundColor="#20000000" />
	 <eLabel name="" position="40,644" size="1210,60" zPosition="1" backgroundColor="#50000000" />
